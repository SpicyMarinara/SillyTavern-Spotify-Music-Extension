// --- START OF FILE SillyTavern/plugins/spotify-music/index.mjs ---
...
const spotifyMusicModule = {
    router,
    info: { id: 'spotify-music', name: 'Spotify Music', description: 'Plays Spotify music based on chat mood analysis.' },
};
export default spotifyMusicModule;
